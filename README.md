...
[13 Tribes Pixel Dungeon](morrowminders.fandom.com/13tribespd) is an open-source traditional roguelike dungeon crawler with randomized levels and enemies, and hundreds of items to collect and use. It's based on the [source code of Shattered Pixel Dungeon](https://github.com/00-Evan/pixel-dungeon-gradle), by [00-Evan](https://shatteredpixel.com/).
